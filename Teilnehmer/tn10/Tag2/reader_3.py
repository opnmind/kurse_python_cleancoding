...
class LogfileIPFinder:
    ...
    def _read_logfile(self, file: str):
        """ Read Logfile """
        with open(file) as file_pointer:
            self._logfile = file_pointer.read()

    def _search_regex(self, regex_pattern: str):
        """ Search Regx Pattern in Logfile """
        matches = re.finditer(regex_pattern, self._logfile, re.MULTILINE)
    ...
    def get_ip4_adresses(self):
        ...
        self._search_regex(self.PATTERN_IP4)
...
if __name__ == "__main__":
 ...
 #   print(LogfileIPFinder.__annotations__)
 #   print(inspect.getfullargspec(LogfileIPFinder))
